...
pub fn make_world() -> Vec<Sphere> {
    ...
    let mat2: Material = Material::Lambertian(Lambertian::new(Vec3::new(0.4, 0.2, 0.1)));
    world.push(Sphere::new(Vec3::new(-4.0, 1.0, 0.0), 1.0, mat2));

    let mat3: Material = Material::Metal(Metal::new(Vec3::new(0.7, 0.6, 0.5), 0.0));
